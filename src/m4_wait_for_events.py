...
def next_prime(m):
    ...
    Examples:
      ...
      -- next_prime(155922)  returns  156007  [trust me!]
    Type hints:
      :type m: int
    """
    # -------------------------------------------------------------------------
...
def run_test_wait_for_sum_of_cubes():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 41
    actual = wait_for_sum_of_cubes(719204)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 28
    actual = wait_for_sum_of_cubes(147919)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
...
def wait_for_sum_of_cubes(x):
    ...
    # Solution 2 (math inclined):
    # Formula: 1 cubed  +  2 cubed  +  3 cubed  +  ...  + n cubed = (n * (n+1) / 2 )^2
    c = math.sqrt(x) * 2
    return math.ceil((-1 + math.sqrt(1 + 4 * c)) / 2)
